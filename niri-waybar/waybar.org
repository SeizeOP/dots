...
* CONFIG
#+begin_src jsonc :tangle ~/dotfiles/niri-waybar/config.jsonc
 //-*- mode: jsonc -*-
#+end_src
...
#+begin_src jsonc :tangle ~/dotfiles/niri-waybar/config.jsonc
  "clock": {
      ...
      //"format-alt": "{:%Y-%m-%d}",
      "on-click": "$HOME/scripts/bash/time-notif.sh"
  },
#+end_src
...
Configuration for the "niri/workspaces" module
#+begin_src jsonc :tangle ~/dotfiles/niri-waybar/config.jsonc
  "niri/workspaces": {
...
#+begin_src css :tangle ~/dotfiles/niri-waybar/style.css
...
#+export_file_name: ~/Documents/html/docs/niri-waybar.html
