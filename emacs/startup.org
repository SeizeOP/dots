  ...
  [[file:~/dotfiles/images/emacs-start-page.png]]

* IMPORTANT KEYBINDINGS [[file:~/dotfiles/images/emacs-start-page-urgent.png]] 
|-----------+---------------------+------------------------------------|
...
| SPC f w   | [[elisp:(find-file (concat (getenv "HOME") "/.config/waybar/waybar.org"))][Waybar.org]]          | Open Personal /Waybar/ [[../waybar/waybar.org][config]]        |
...
* EMACS CONFIG FILES  [[file:~/dotfiles/images/emacs-start-page-urgent.png]] 
|---+--------------------------+--------------------------------------------------------|
