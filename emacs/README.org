...
#+begin_src emacs-lisp
  (hd/leader-keys
    ...
    "c R" '(revert-buffer-quick :wk "Uncomment selected region")
...
#+begin_src emacs-lisp
;;(add-hook 'org-mode-hook (lambda () (set-frame-font "Open Dyslexic" t)))
  (add-hook 'org-mode-hook (lambda () 
  			   (setq buffer-face-mode-face '(:family "Open Dyslexic"))
  			   (buffer-face-mode)))
#+end_src

Exclude Orgmode codeblocks and tables from ~Open Dyslexic~ font selection
#+begin_src emacs-lisp
