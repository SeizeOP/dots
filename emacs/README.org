...
- [[#dashboard][DASHBOARD]]
  - [[#install-spacemacs-dashboard][Install /Spacemacs/ dashboard]]
  - [[#customize-spacemacs-dashboard][Customize /Spacemacs/ dashboard]]
  - [[#icons][Icons]]
- [[#modeline][MODELINE]]
- [[#emms][EMMS]]
- [[#elfeed][ELFEED]]
...
* THEME
The first of the two lines below designates the directory where we will place all of our themes. The second line loads our chosen theme which is *Seize the night*, a theme that i created with the help of the [[https://mswift42.github.io/themecreator/][Emacs Theme Editor]].
